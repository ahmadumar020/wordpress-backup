...
do_action( 'woocommerce_before_edit_account_form' ); ?>
	...
	<h2 class="custom-woocommerce-title">
	Change Password and your personal info
	</h2>
...
<form class="woocommerce-EditAccountForm edit-account" action=""
  ...
  <p style="display:none;" class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
    ...
    <span><em><?php esc_html_e( 'This will be how your name will be displayed in the account section and in reviews, if enabled', 'woocommerce' ); ?></em></span>
  </p>
  <div class="clear"></div>
  ...
  <p class="submit-button-form-margin-top">
